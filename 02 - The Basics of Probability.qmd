...
- $S = [0,\infty)$  
- Continuous (any nonnegative real number)  
...
But the two options are **not equally likely**, most people are healty.
...
## Interpreting the Axioms {.smaller}

::: {.infobox}
1. **Non-negativity**

A probability can **never be negative**  
A negative probability has no meaning, $P=0$ already means that an event is impossible
:::
...
## Example: Bus waiting times {.smaller}
...
$$
A \cup B = (A^c \cap B^c)^c = (1 - ((1-P(A)) \cdot (1-P(B)))) = 0.75
$$
...
## Other Useful Properties - Commutative Law
...
## Other Useful Properties - Distributive Laws
...
## Other Useful Properties - self union and self intersection
